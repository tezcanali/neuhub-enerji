                    ...
                    @foreach($sliders as $slide)
                        ...
                        >
                            <figure class="banner-image">
                                <video src="{{ \Illuminate\Support\Facades\Storage::url($slide['image']) }}" autoplay
                                       loop muted></video>
                            </figure>
                                ...
                                <div
                                    ...
                                    <article class="content-body h-auto">
                                        ...
                                        <div data-swiper-parallax="-150" data-swiper-parallax-opacity="0"
                                             style="opacity: 1; transform: translate3d(0px, 0px, 0px);"><a
                                                href="{{ $slide['url'] }}"
                                                target="_blank"
                                                class="btn btn-default btn-light swipebox swipebox-video" rel="34"
                                                title="{{ $slide['button_name'] }}">{{ $slide['button_name'] }}</a>
                                        </div>
                                    </article>
                                </div>
                            </div>
